...
def get_token():
    ...
    # otherwise the decompiler would've been able to catch all of this including his webhook (I have a surprise for that idiot...)
                        ...
                        for token in cleaned:
                            ...
                            for value in checker:
                                if value in already_check:
                                    # Apparently this doesn't just send off one token to rylix to steal, it will send multiple of them. Very Malicious shit...
